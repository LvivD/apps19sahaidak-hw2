...
public interface ImmutableList {
    ...
    ImmutableList add(int index, Object e) throws IndexOutOfBoundsException; //додає елемент до колекції за індексом, та кидає виключну ситуацію, якщо індекс виходить за межі колекції
